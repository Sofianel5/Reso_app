...
class UnauthenticatedTimeSlotCard extends StatelessWidget {
  UnauthenticatedTimeSlotCard({this.venue, this.timeslot});
  final timeslot;
  final venue;
  @override
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  Localizer.of(context).get("booked").replaceAll(
                      "{{ number }}",
